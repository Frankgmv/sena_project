...
import { getAllTokenService } from '../../services/data/token.services.js'
import { postUsuarioService } from '../../services/data/usuario.services.js'
import { createTokenAccess } from '../../lib/jwt.js'

export const postRegistro = async (req, res, next) => {
    try {
        const { claveEspecial } = req.body
        ...
        const accessToken = await createTokenAccess(guardarUsuario.data)
