...
import { deleteLink, getAllLink, getLink, getLinksExterno, postLink, putLink } from '../../controllers/data/link.controller.js'
...
linkRouter.get('/links-menu', getLinksExterno)
